...
For physical-device builds, configure the app and the `MinuteWidgets` extension with the same paid Developer Team and shared App Group: `group.com.minuteapp.Minute`.
